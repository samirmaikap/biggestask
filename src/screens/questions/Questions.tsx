    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <View style={styles.innerContainer}>
          <AppText>
            Get to know your surrogacy partner as the journey unfolds. The app
            will send you and your surrogacy partner questions and exchange the
            answers. As the journey progresses, the questions become more
            interesting and intimate, so that you bond naturally with each
            other. Select how often you'd like to answer a question
          </AppText>
          <AppSpacing gap={16} />
          ...
          {[1, 2, 3].map((item, index) => {
            return (
              <View style={{marginVertical: 8}} key={`i-${index}`}>
                <QuestionCard
